...
$lang = array(
    ...
    "success_text" => "Расчет выполнен! Территория страхования: %world% Период страхования: %date_to% - %date_back% (%days_total% д.)* *К выбранному Вами периоду страхования, будет автоматически добавлено 15 календарных дней, в соответствие с Решением Совета ЕС 2004/17/ EG об условиях медицинского страхования путешествующих лицСтраховая сумма %world_total1%€. Несчастный случай %world_total2%€. Доп. опции: ...Цена полиса: %price%грн",
