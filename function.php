...
$lang = [
    ...
    "error_date_to_text" => "Введите пожалуйста коректную дату, которая больше сегодняшнего дня в формате ДД.ММ.ГГГГ",
    ...
    "email_error_text" => 'Введите пожалуйста коректный электронный адресс в формате  xxxx@xxx.xx',
